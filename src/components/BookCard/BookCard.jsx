...
import DeleteBook from '../DeleteBook/DeleteBook.jsx'; // استيراد مكون حذف الكتاب

const BookCard = ({ book, onSelect, onDelete }) => {
    const [showDeleteModal, setShowDeleteModal] = useState(false); // حالة لإظهار مودال الحذف

    const handleDeleteComplete = (bookId) => {
        onDelete(bookId); // استدعاء الدالة الممررة لحذف الكتاب من القائمة
    };
